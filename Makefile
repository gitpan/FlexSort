# This Makefile is for the File::FlexSort extension to perl.
#
...
#	ABSTRACT_FROM => q[FlexSort.pm]
#	AUTHOR => q[Christopher Brown <Chris.Brown@alum.calberkeley.org>]
#	NAME => q[File::FlexSort]
#	PREREQ_PM => { IO::Zlib=>q[1], IO::File=>q[1.08] }
#	VERSION_FROM => q[FlexSort.pm]
...
AR_STATIC_ARGS = cr
NAME = File::FlexSort
DISTNAME = File-FlexSort
NAME_SYM = File_FlexSort
VERSION = 0.75
VERSION_SYM = 0_75
XS_VERSION = 0.75
INST_BIN = blib\bin
...
FULLEXT = File\FlexSort
BASEEXT = FlexSort
PARENT_NAME = File
DLBASE = $(BASEEXT)
VERSION_FROM = FlexSort.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
EXPORT_LIST = FlexSort.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = FlexSort.pm

PM_TO_BLIB = FlexSort.pm \
	$(INST_LIBDIR)\FlexSort.pm
...
FlexSort.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'File::FlexSort', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f  $(INST_LIBDIR)\FlexSort.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"File-FlexSort\" VERSION=\"0,75,0,0\">\n}. qq{\t<TITLE>File-FlexSort</TITLE>\n}. qq{\t<ABSTRACT>Perl extension for merging and processing data </ABSTRACT>\n}. qq{\t<AUTHOR>Christopher Brown &lt;Chris.Brown\@alum.calberkeley.org&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"IO-File\" VERSION=\"1,08,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"IO-Zlib\" VERSION=\"1,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > File-FlexSort.ppd
